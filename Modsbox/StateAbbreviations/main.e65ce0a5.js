this.wordle = this.wordle || {}, this.wordle.bundle = function(e) {
    ...
    var La = ["al", "ak", "az", "ar", "ca", "co", "ct", "de", "fl", "ga", "hi", "id", "il", "in", "ia", "ks", "ky", "la", "me", "md", "ma", "mi", "mn", "ms", "mo", "mt", "ne", "nv", "nh", "nj", "nm", "ny", "nc", "nd", "oh", "ok", "or", "pa", "ri", "sc", "sd", "tn", "tx", "ut", "vt", "va", "wa", "wv", "wi", "wy"],
    Ta = ["al", "ak", "az", "ar", "ca", "co", "ct", "de", "fl", "ga", "hi", "id", "il", "in", "ia", "ks", "ky", "la", "me", "md", "ma", "mi", "mn", "ms", "mo", "mt", "ne", "nv", "nh", "nj", "nm", "ny", "nc", "nd", "oh", "ok", "or", "pa", "ri", "sc", "sd", "tn", "tx", "ut", "vt", "va", "wa", "wv", "wi", "wy"],
        Ia = "present",
        Ma = "correct",
        Oa = "absent";
    var Ra = {
    ...
    function Na(e, a) {
        ...
        var i = getRandomIntInclusive(1,48);
        console.log(La[i]);
        return i;
    ...
    var Za = "IN_PROGRESS",
        ...
        ts = function(e) {
            ...
            return o(t, [{
                key: "evaluateRow",
                value: function() {
                    if (2 === this.tileIndex && !(this.rowIndex >= 5)) {
                        var e, a = this.$board.querySelectorAll("game-row")[this.rowIndex],
                            s = this.boardState[this.rowIndex];
                        if (e = s, !Ta.includes(e) && !La.includes(e)) return a.setAttribute("invalid", ""), void this.addToast("Not an abbreviation");
                        if (this.hardMode) {
                ...
                value: function() {
                    var e = this.shadowRoot.querySelector("#board-container"),
                        a = Math.min(Math.floor(e.clientHeight * (2 / 5)), 350),
                        s = 5 * Math.floor(a / 2);
    ...
    $s.innerHTML = '\n  <style>\n  .instructions {\n    font-size: 14px;\n    color: var(--color-tone-1)\n  }\n\n  .examples {\n    border-bottom: 1px solid var(--color-tone-4);\n    border-top: 1px solid var(--color-tone-4);\n  }\n\n  .example {\n    margin-top: 24px;\n    margin-bottom: 24px;\n  }\n\n  game-tile {\n    width: 40px;\n    height: 40px;\n  }\n\n  :host([page]) section {\n    padding: 16px;\n    padding-top: 0px;\n  }\n\n  </style>\n  <section>\n    <div class="instructions">\n      <p>Guess the <strong>STATE-LE</strong> in 5 tries.</p>\n      <p>Each guess must be a valid 2 character abbreviation. Hit the enter button to submit.</p>\n      <p>After each guess, the color of the tiles will change to show how close your guess was to the correct abbreviation.</p>\n      <div class="examples">\n        <p><strong>Examples</strong></p>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="v" evaluation="correct" reveal></game-tile>\n            <game-tile letter="a"></game-tile>\n           </div>\n          <p>The letter <strong>V</strong> is in the abbreviation and in the correct spot.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="w"></game-tile>\n            <game-tile letter="i" evaluation="present" reveal></game-tile>\n          </div>\n          <p>The letter <strong>I</strong> is in the abbreviation but in the wrong spot.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="n"></game-tile>\n   <game-tile letter="e" evaluation="absent" reveal></game-tile>\n          </div>\n          <p>The letter <strong>E</strong> is not in the abbreviation in any spot.</p>\n        </div>\n      </div>\n      <p><strong>A new STATE-LE will be available by refreshing the page!<strong></p>\n    </div>\n  </section>\n';
    var Hs = function(e) {
        r(t, e);
        var a = h(t);
